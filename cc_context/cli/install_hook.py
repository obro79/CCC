...
if [ "$CHECKOUT_TYPE" = "1" ]; then
    ...
    if [ -d "$SNAPSHOT_DIR" ]; then
        echo ""
        echo "💬 Claude Code context available for this commit!"
        echo "   Run: cc-restore"
        echo ""
    fi
fi
...
"""
        ...
        if post_checkout_hook.exists():
            ...
            post_checkout_hook.write_text(post_checkout_content)
            post_checkout_hook.chmod(0o755)
            print(f"✓  Installed post-checkout hook at: {post_checkout_hook}")
        ...
        print("  • Capture Claude Code context after every commit")
        print("  • Notify when context is available after checkout")
        print()
